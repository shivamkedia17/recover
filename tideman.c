...
void lock_pairs(void) //Error
{
    for (int i = 0; i < pair_count; i++)
    {
        ...
        {
            if (locked[pairs[j].winner][pairs[i].winner] == false && locked[pairs[i].loser][pairs[j].winner] == false)
            {
...
void print_winner(void) //Error
{
    ...
    for (int i = 0; i < pair_count; i++)
    {
        for (int j = 0; j < candidate_count; j++)
        {
            if (locked[pairs[i].winner][pairs[i].loser] == true && locked[j][pairs[i].winner] == true)
            {
                check = false;
            }
        }
